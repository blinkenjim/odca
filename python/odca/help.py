...
colors. The files play in turn, each its pairs in order, looping.
  ...
  --longest     play the seeds odca-evolve recorded instead: for every
                ...
                rule with nothing but survivors is left out. The window is
                as wide as the seeds: a wider one shows black bars, a
                narrower one crops. With --shuffle the seeds play in a
