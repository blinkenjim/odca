...
| `platformio/` | early MCU port, two boards: on RP2350, the engine (R-M), boring detector (R-A), and display are running together; on ESP32-C6, only the toolchain is proven so far; see `platformio/README.md` |
