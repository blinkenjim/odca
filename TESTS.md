...
| PT-46 | R-E5 | With rules a, b, c and lifetimes at width 8 of {5000, 4000, 3000}, {2000, 1500}, and {4500}: a runs (c's 4500 outlives 2700); without c's seeds a gives up its turn, reporting shortest 3000 against longest 2000, b runs (behind), c runs (no seeds); a holding {2222, 2221} runs (1998.9 is under 2000) and holding {2223} alone gives up (2000.7); at width 9 a runs (no seeds there); with no other rule holding seeds a runs; a rule outside the file's pairs holding 5000 does not count. |
