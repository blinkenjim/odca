...
- **M-15** `odca my.odca --longest` after M-14: the window opens 1200
  ...
  same way, crisp at a whole-number factor and slightly soft otherwise; each seed runs to its
